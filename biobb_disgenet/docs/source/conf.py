...
htmlhelp_basename = 'biobb_disgenet_doc'
...
latex_documents = [
    (master_doc, 'biobb_disgenet.tex', u'biobb_disgenet Documentation',
...
man_pages = [
    (master_doc, 'biobb_disgenet', u'biobb_disgenet Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_disgenet', u'biobb_disgenet Documentation',
     author, 'biobb_disgenet', 'biobb_disgenet Disgenet building block',
     'Miscellaneous'),
]
